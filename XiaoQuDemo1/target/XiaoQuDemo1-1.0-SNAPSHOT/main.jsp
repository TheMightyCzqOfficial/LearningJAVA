...
<nav class="navbar navbar-default">
    <div class="container-fluid" >
        ...
        <div class="page-header">
            <h1>小区管理系统-管理员端 <small id="datetime"></small>

            </h1>
        </div>
        <div class="hotcontent advice">
            <span class="produce"><h4>最新公告</h4></span>
            <marquee direction="left" behavior="scroll" scrollamount="10">
                <span class="glyphicon glyphicon-bullhorn"></span>
            <span >欢迎使用本系统，祝您开心打工每一天
            </span>
            </marquee>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav nav-tabs">
                ...
                <li role="presentation"><a href="#" onclick="document.getElementById('frame').src='/CarServlet'">车辆信息</a></li>
